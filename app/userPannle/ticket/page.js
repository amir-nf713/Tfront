    ...
    <div className="min-h-screen bg-gray-50 p-6">
        ...
        {tickets.length > 0 ? (
          tickets.map((ticket) => (
            ...
            >
              ...
              {ticket.status === "درحال بررسی" && (
                <Link
                  href={`/userPannle/ticket/page?id=${ticket._id}`}
          ...
          <div className="flex items-center justify-center rounded-lg p-6 text-gray-600">
            تیکتی ثبت نکردید
          </div>
        )}
      </div>
      ...
      <Popup
        ...
        onClose={() => {
          ...
          fetchData(); // بعد از بستن مودال، لیست را بروزرسانی می‌کنیم
        }}
      />
    </div>
  );
